...
from transformers import AutoProcessor, AutoModelForCausalLM, BlipForConditionalGeneration, Blip2ForConditionalGeneration, VisionEncoderDecoderModel
...
class Interrogator():
    def __init__(self, config: Config):
        ...
        # self.caption_model_path = '~/.cache/huggingface/hub/models--Salesforce--blip-image-captioning-base'
    ...
    def load_caption_model(self): 
        if self.config.caption_model is None and self.config.caption_model_name:
            ...
            # print("caption_model_name",self.config.caption_model_name)
